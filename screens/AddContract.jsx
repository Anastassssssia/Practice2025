...
export default function AddContract({navigation}) {
  ...
  return (
    <SafeAreaView style={styles.safeContainer}>
      <View style={styles.headerContainer}>
        <TouchableOpacity style={styles.headerButton} onPress={() => navigation.navigate('Main', {screen: 'Договори'})}>
          <AntDesign name="arrowleft" size={25} color="#2B2C34"/>
        </TouchableOpacity>
        <Text style={styles.headerTitle}>Додати договір</Text>
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={[styles.dropdownContainer, open === 'contract' && styles.activeBackground]}>
            ...
            <DropDownPicker placeholder='Тип договору' listMode="SCROLLVIEW" dropDownDirection="DOWN"
              ...
              items={[
                ...
                {label: 'купівля-продаж', value: 'купівля-продаж'},
              ]}
          ...
          <View style={[styles.inputContainer, styles.iconBox, styles.inputFull, activeInput === 'clientOwner' && styles.activeBackground]}>
            <MaterialCommunityIcons name="account" size={24} color="#2B2C34"/>
            <TextInput style={[styles.textValue, {flexShrink: 1, width: '100%'}]} onFocus={() => setActiveInput('clientOwner')} onBlur={() => setActiveInput(null)} placeholder='Власник' placeholderTextColor="#2B2C34"/>
          </View>

          <View style={[styles.inputContainer, styles.iconBox, styles.inputFull, activeInput === 'clientSearch' && styles.activeBackground]}>
            <MaterialCommunityIcons name="account" size={24} color="#2B2C34"/>
            <TextInput style={[styles.textValue, {flexShrink: 1, width: '100%'}]} onFocus={() => setActiveInput('clientSearch')} onBlur={() => setActiveInput(null)} placeholder='Пошуковець' placeholderTextColor="#2B2C34"/>
          </View>
          ...
          {showPicker.end && valueContract !== 'купівля-продаж' &&(
      ...
      <View style={styles.bottomContainer}>
        <TouchableOpacity style={styles.saveButton} onPress={() => navigation.navigate('Main', {screen: 'Договори'})}>
